...
export function TickerStatementTab({ metrics, status = "idle" }: TickerStatementTabProps) {
  if (status === "no-key") {
    return (
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 items-start lg:items-stretch">
      <div className="h-full max-h-[520px] rounded-lg border border-slate-200 bg-white/70 p-3 text-sm text-slate-700 flex flex-col">
      ...
      <div className="lg:col-span-3 space-y-4 max-h-[520px] flex flex-col">
