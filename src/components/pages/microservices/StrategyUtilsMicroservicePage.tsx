...
/**
 * Componente per la gestione della pagina del microservizio Strategy Utils
 *
 ...
 * - Logs
 */
export default function StrategyUtilsMicroservicePage({
  onReleaseChange,
  onHealthChange,
  onOpenReleaseModal,
}: Props) {
