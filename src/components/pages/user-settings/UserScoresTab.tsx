...
import { ScoreFormulaCard, Comparator } from "./ScoreFormulaCard";
...
export default function UserScoresTab() {
  ...
  const momentumWeights = handlesToMomentumWeights(momentumHandles);
  ...
  const [genericFilters, setGenericFilters] = useState(baseFilters);
  ...
  const qualityWeights = handlesToQualityWeights(qualityHandles);
