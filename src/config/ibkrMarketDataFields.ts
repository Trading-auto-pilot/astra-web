export const IBKR_MARKET_DATA_FIELDS: Record<string, string> = {
  ...
  "7686": "Upcoming Earnings. The date and time of the next scheduled earnings/earnings call event.",
  ...
  "7689": "Recent Earnings. The date and time of the most recent earnings/earning call event.",
